...
resource: https://doc.rust-lang.org/stable/book/ch08-02-strings.html
...
`fn add(self, s: &str) -> String {`In the standard library, you’ll see `add` defined using generics and associated
...
1. Source page: https://doc.rust-lang.org/stable/book/ch08-02-strings.html
